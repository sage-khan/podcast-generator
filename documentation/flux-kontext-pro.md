...
- prompt: Text description of what you want to generate, or the instruction on how to edit the given image. (string)
- input_image: Image to use as reference. Must be jpeg, png, gif, or webp. (string)
...
### Example (https://replicate.com/p/gkc6hhqqt1rm80cq25ds54c6dm)
...
```json
"https://replicate.delivery/xezq/3fnmT0SN53xVcqoePFMaeyx5v0cPPvBAyWWjqOWHGGAxUphpA/tmpdl8gt6s4.png"
```
...
| Field | Type | Description | Default value | Minimum | Maximum |
| --- | --- | --- | --- | --- | --- |
| `seed` | `integer` | Random seed. Set for reproducible generation |  |  |  |
| `prompt` | `string` | Text description of what you want to generate, or the instruction on how to edit the given image. |  |  |  |
| `input_image` | `uri` | Image to use as reference. Must be jpeg, png, gif, or webp. |  |  |  |
...
| `safety_tolerance` | `integer` | Safety tolerance, 0 is most strict and 6 is most permissive. 2 is currently the maximum allowed when input images are used. | `2` | `0` | `6` |

### Output schema

| Field | Type | Description |
| --- | --- | --- |
| `output` | `uri` | URI of the generated image |